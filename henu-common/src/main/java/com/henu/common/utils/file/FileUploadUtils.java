package com.henu.common.utils.file;
...
import com.henu.common.exception.file.FileNameLengthLimitExceededException;
import com.henu.common.exception.file.FileSizeLimitExceededException;
import com.henu.common.exception.file.InvalidExtensionException;
import com.henu.common.utils.DateUtils;
import com.henu.common.utils.StringUtils;
import com.henu.common.utils.uuid.IdUtils;
import com.henu.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = HenuConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = HenuConfig.getProfile().length() + 1;
