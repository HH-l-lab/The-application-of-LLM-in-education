  ...
  <div class="app-container system-page">
    <div class="page-header">
      <div class="header-left">
        <h2><i class="el-icon-s-check"></i> 角色管理</h2>
      </div>
    </div>
  ...
  methods: {
    ...
    getList() {
      ...
      listRole(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
          this.roleList = response.rows.filter(item => item.roleId !== 1); this.total = response.total - (response.rows.length - this.roleList.length)
